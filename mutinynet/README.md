...
| 11a-x1-cas-update-smt-proof | x1 | genesis cas, 1 update cas, SMT proof sidecar | versionId 2 | [`x1/q4as9ul0/`](./x1/q4as9ul0/) |
| 11b-x1-cas-update-smt-proof-paired | x1 | genesis cas, 1 update cas, SMT proof sidecar | versionId 2 | [`x1/qklrxhg4/`](./x1/qklrxhg4/) |
| 12a-x1-sidecar-update-smt-proof | x1 | genesis sidecar, 1 update sidecar, SMT proof sidecar | versionId 2 | [`x1/q4zfcvh0/`](./x1/q4zfcvh0/) |
| 12b-x1-sidecar-update-smt-proof-paired | x1 | genesis sidecar, 1 update sidecar, SMT proof sidecar | versionId 2 | [`x1/q53st3h5/`](./x1/q53st3h5/) |
...
| 25a-x1-smt-update-no-nonce | x1 | genesis sidecar, 1 update sidecar, SMT proof sidecar, no nonce | versionId 2 | [`x1/qhwkcy3u/`](./x1/qhwkcy3u/) |
| 25b-x1-smt-nonce-no-update | x1 | genesis sidecar, no update, SMT proof sidecar | versionId 1 | [`x1/qhyt2nkm/`](./x1/qhyt2nkm/) |
| 25c-x1-smt-empty-index | x1 | genesis sidecar, no update, SMT proof sidecar, no nonce | versionId 1 | [`x1/qh2etls9/`](./x1/qh2etls9/) |
| 26-k1-signal-below-current-height | k1 | 2 updates sidecar | versionId 2 | [`k1/q5pfvsce/`](./k1/q5pfvsce/) |
...
| n29-x1-smt-proof-hash | x1 | genesis sidecar, 1 update sidecar, SMT proof sidecar (`hash` changed) | error `INVALID_SIGNAL_DATA` | [`x1/qk66z56a/`](./x1/qk66z56a/) |
| n30-x1-smt-proof-root-id | x1 | genesis sidecar, 1 update sidecar, SMT proof sidecar (`id` changed) | error `MISSING_UPDATE_DATA` | [`x1/q5cegwvp/`](./x1/q5cegwvp/) |
| n31-x1-smt-proof-withheld | x1 | genesis sidecar, 1 update sidecar, no SMT proof | error `MISSING_UPDATE_DATA` | [`x1/q5x8n94l/`](./x1/q5x8n94l/) |
