...
| 11a-x1-cas-update-smt-proof | x1 | genesis cas, 1 update cas, SMT proof sidecar | versionId 2 | [`x1/qsvhmpzp/`](./x1/qsvhmpzp/) |
| 11b-x1-cas-update-smt-proof-paired | x1 | genesis cas, 1 update cas, SMT proof sidecar | versionId 2 | [`x1/qsk6l540/`](./x1/qsk6l540/) |
| 12a-x1-sidecar-update-smt-proof | x1 | genesis sidecar, 1 update sidecar, SMT proof sidecar | versionId 2 | [`x1/q3kwecw9/`](./x1/q3kwecw9/) |
| 12b-x1-sidecar-update-smt-proof-paired | x1 | genesis sidecar, 1 update sidecar, SMT proof sidecar | versionId 2 | [`x1/qj7t8rsc/`](./x1/qj7t8rsc/) |
...
| 25a-x1-smt-update-no-nonce | x1 | genesis sidecar, 1 update sidecar, SMT proof sidecar, no nonce | versionId 2 | [`x1/q3wj7wpq/`](./x1/q3wj7wpq/) |
| 25b-x1-smt-nonce-no-update | x1 | genesis sidecar, no update, SMT proof sidecar | versionId 1 | [`x1/qsp4ahzq/`](./x1/qsp4ahzq/) |
| 25c-x1-smt-empty-index | x1 | genesis sidecar, no update, SMT proof sidecar, no nonce | versionId 1 | [`x1/qn7jezzt/`](./x1/qn7jezzt/) |
| 26-k1-signal-below-current-height | k1 | 2 updates sidecar | versionId 2 | [`k1/qspn3pvr/`](./k1/qspn3pvr/) |
...
DID: `did:btcr2:x1qsvhmpzpn6sj23e327lklrc5jvkwc75dwwte60974h98er67ge9tx0ahh9x`
...
DID: `did:btcr2:x1qsk6l5407kmzdxuy9cu7hsyqjsmlluqfcv94qaazc0l8v7qv2d5027zsr8f`
...
DID: `did:btcr2:x1q3kwecw9ahm2y6smrm4kca8sn5srah2pfe93hpclngl0shxknr7d79ngxaz`
...
DID: `did:btcr2:x1qj7t8rscjdaf2dgzyw2v77r6hhjemqjr8vfr8p8fhev0a9p8pmzzcjwylva`
...
DID: `did:btcr2:x1q3wj7wpqgwzuyjye5r5dmgvk2cram267he34kqtum7n5syrvdphrxtlnqyn`
...
DID: `did:btcr2:x1qsp4ahzqm0aal4thjy6624kzvt90fxutss3tnjkfaqezvaeqt6l5yxyzmxx`
...
DID: `did:btcr2:x1qn7jezztzuhgtkfug2taevwe5pr7es3ctffkv0r93ewy6s24r8ekc54fxwk`
...
DID: `did:btcr2:k1qspn3pvrjemg66qm6n3nxavk49lxa2ylk84w0g85afxc7rfx4g4vwqqfz9ws6`
...
| n29-x1-smt-proof-hash | x1 | genesis sidecar, 1 update sidecar, SMT proof sidecar (`hash` changed) | error `INVALID_SIGNAL_DATA` | [`x1/qs3ep4v7/`](./x1/qs3ep4v7/) |
| n30-x1-smt-proof-root-id | x1 | genesis sidecar, 1 update sidecar, SMT proof sidecar (`id` changed) | error `MISSING_UPDATE_DATA` | [`x1/qsjx2r7d/`](./x1/qsjx2r7d/) |
| n31-x1-smt-proof-withheld | x1 | genesis sidecar, 1 update sidecar, no SMT proof | error `MISSING_UPDATE_DATA` | [`x1/qj0ku5u9/`](./x1/qj0ku5u9/) |
...
DID: `did:btcr2:x1qs3ep4v7fqft6rw94rrfd7uq7nmjn2yacx99sfcktzms3veq8fx55mm88ru`
...
DID: `did:btcr2:x1qsjx2r7dsl52xul9seyveqqhp5ddpfj70hxra47deuu4uqch4r2egtq9gsp`

### n31-x1-smt-proof-withheld

Negative: x1 DID in the SMT cohort smt-25 with 1 sidecar update; the sidecar holds no SMT proof.

DID: `did:btcr2:x1qj0ku5u9006h309k5jasq0kazwv47duz50uv7mzx7x3akxy6aawagc5wjg7`
